...
public class Configuration : IReadableConfiguration
{
    ...
    /// <param name="inputVariables">Dictionary of the variables and the corresponding values.</param>
    /// <return>The operation server URL.</return>
    public string GetOperationServerUrl(string operation, int index, Dictionary<string, string> inputVariables) => OperationServers.TryGetValue(operation, out var operationServer) ? GetServerUrl(operationServer, index, inputVariables) : null;
