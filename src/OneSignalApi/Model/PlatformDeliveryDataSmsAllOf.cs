...
public partial class PlatformDeliveryDataSmsAllOf : IEquatable<PlatformDeliveryDataSmsAllOf>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as PlatformDeliveryDataSmsAllOf);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(PlatformDeliveryDataSmsAllOf input) => input == null
            ? false
            : (
