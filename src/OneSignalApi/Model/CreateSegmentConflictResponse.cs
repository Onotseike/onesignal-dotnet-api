...
public partial class CreateSegmentConflictResponse : IEquatable<CreateSegmentConflictResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as CreateSegmentConflictResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(CreateSegmentConflictResponse input) => input == null
            ? false
            : (
