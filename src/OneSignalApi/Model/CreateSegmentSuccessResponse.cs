...
public partial class CreateSegmentSuccessResponse : IEquatable<CreateSegmentSuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as CreateSegmentSuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(CreateSegmentSuccessResponse input) => input == null
            ? false
            : (
