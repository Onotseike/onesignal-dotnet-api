...
public partial class ExportPlayersSuccessResponse : IEquatable<ExportPlayersSuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as ExportPlayersSuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(ExportPlayersSuccessResponse input) => input == null
            ? false
