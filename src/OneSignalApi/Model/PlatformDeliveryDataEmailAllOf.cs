...
public partial class PlatformDeliveryDataEmailAllOf : IEquatable<PlatformDeliveryDataEmailAllOf>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as PlatformDeliveryDataEmailAllOf);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(PlatformDeliveryDataEmailAllOf input) => input == null
            ? false
            : (
