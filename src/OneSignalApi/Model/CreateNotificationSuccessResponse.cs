...
public partial class CreateNotificationSuccessResponse : IEquatable<CreateNotificationSuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as CreateNotificationSuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(CreateNotificationSuccessResponse input) => input == null
            ? false
            : (
                this.Id == input.Id ||
                (this.Id != null &&
