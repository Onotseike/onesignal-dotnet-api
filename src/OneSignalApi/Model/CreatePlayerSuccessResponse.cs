...
public partial class CreatePlayerSuccessResponse : IEquatable<CreatePlayerSuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as CreatePlayerSuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(CreatePlayerSuccessResponse input) => input == null
            ? false
            : (
