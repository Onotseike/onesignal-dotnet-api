...
public partial class DeleteSegmentSuccessResponse : IEquatable<DeleteSegmentSuccessResponse>, IValidatableObject
{
    ...
    public DeleteSegmentSuccessResponse(bool success = default) => this.Success = success;
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class DeleteSegmentSuccessResponse {\n");
    ...
    public override bool Equals(object input) => this.Equals(input as DeleteSegmentSuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(DeleteSegmentSuccessResponse input) => input == null
            ? false
