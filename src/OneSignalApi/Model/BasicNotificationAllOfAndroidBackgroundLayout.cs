...
public partial class BasicNotificationAllOfAndroidBackgroundLayout : IEquatable<BasicNotificationAllOfAndroidBackgroundLayout>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as BasicNotificationAllOfAndroidBackgroundLayout);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(BasicNotificationAllOfAndroidBackgroundLayout input) => input == null
            ? false
            : (
