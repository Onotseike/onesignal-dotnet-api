...
public partial class CreateSubscriptionRequestBody : IEquatable<CreateSubscriptionRequestBody>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as CreateSubscriptionRequestBody);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(CreateSubscriptionRequestBody input) => input == null
            ? false
            : (
