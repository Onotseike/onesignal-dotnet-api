...
public partial class NotificationHistorySuccessResponse : IEquatable<NotificationHistorySuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as NotificationHistorySuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(NotificationHistorySuccessResponse input) => input == null
            ? false
            : (
