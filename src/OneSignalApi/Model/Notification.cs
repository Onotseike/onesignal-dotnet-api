...
public partial class Notification : IEquatable<Notification>, IValidatableObject
{
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class Notification {\n");
    ...
    public override bool Equals(object input) => this.Equals(input as Notification);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(Notification input) => input == null
            ? false
            : (
