...
public partial class DeletePlayerNotFoundResponse : IEquatable<DeletePlayerNotFoundResponse>, IValidatableObject
{
    ...
    public DeletePlayerNotFoundResponse(bool success = default) => this.Success = success;
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class DeletePlayerNotFoundResponse {\n");
    ...
    public override bool Equals(object input) => this.Equals(input as DeletePlayerNotFoundResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(DeletePlayerNotFoundResponse input) => input == null
            ? false
