...
public partial class GetNotificationRequestBody : IEquatable<GetNotificationRequestBody>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as GetNotificationRequestBody);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(GetNotificationRequestBody input) => input == null
            ? false
            : (
