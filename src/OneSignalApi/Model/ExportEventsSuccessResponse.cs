...
public partial class ExportEventsSuccessResponse : IEquatable<ExportEventsSuccessResponse>, IValidatableObject
{
    ...
    public ExportEventsSuccessResponse(string csvFileUrl = default) => this.CsvFileUrl = csvFileUrl;
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class ExportEventsSuccessResponse {\n");
    ...
    /// <returns>Boolean</returns>
    public bool Equals(ExportEventsSuccessResponse input) => input == null
            ? false
