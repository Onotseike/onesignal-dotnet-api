...
public partial class FilterExpressions : AbstractOpenAPISchema, IEquatable<FilterExpressions>, IValidatableObject
{
    ...
    /// <returns>Boolean</returns>
    public bool Equals(FilterExpressions input) => input == null ? false : this.ActualInstance.Equals(input.ActualInstance);
...
public class FilterExpressionsJsonConverter : JsonConverter
{
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer) => reader.TokenType != JsonToken.Null ? FilterExpressions.FromJson(JObject.Load(reader).ToString(Formatting.None)) : (object)null;
