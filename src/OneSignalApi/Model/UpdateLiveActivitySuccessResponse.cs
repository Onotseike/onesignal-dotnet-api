...
public partial class UpdateLiveActivitySuccessResponse : IEquatable<UpdateLiveActivitySuccessResponse>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as UpdateLiveActivitySuccessResponse);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(UpdateLiveActivitySuccessResponse input) => input == null
            ? false
            : (
