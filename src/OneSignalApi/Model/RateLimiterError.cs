...
public partial class RateLimiterError : IEquatable<RateLimiterError>, IValidatableObject
{
    ...
    public RateLimiterError(List<GenericErrorErrorsInner> errors = default) => this.Errors = errors;
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class RateLimiterError {\n");
    ...
    /// <returns>Boolean</returns>
    public bool Equals(RateLimiterError input) => input == null
            ? false
