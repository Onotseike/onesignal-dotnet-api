...
public partial class TransferSubscriptionRequestBody : IEquatable<TransferSubscriptionRequestBody>, IValidatableObject
{
    ...
    public override bool Equals(object input) => this.Equals(input as TransferSubscriptionRequestBody);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(TransferSubscriptionRequestBody input) => input == null
            ? false
