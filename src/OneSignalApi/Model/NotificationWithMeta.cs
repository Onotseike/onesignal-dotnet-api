...
public partial class NotificationWithMeta : IEquatable<NotificationWithMeta>, IValidatableObject
{
    ...
    public NotificationWithMeta(List<string> includedSegments = default, List<string> excludedSegments = default, List<string> includePlayerIds = default, List<string> includeExternalUserIds = default, List<string> includeEmailTokens = default, List<string> includePhoneNumbers = default, List<string> includeIosTokens = default, List<string> includeWpWnsUris = default, List<string> includeAmazonRegIds = default, List<string> includeChromeRegIds = default, List<string> includeChromeWebRegIds = default, List<string> includeAndroidRegIds = default, PlayerNotificationTargetIncludeAliases includeAliases = default, TargetChannelEnum? targetChannel = default, string id = default, string name = default, bool? isIos = default, bool? isAndroid = default, bool? isHuawei = default, bool? isAnyWeb = default, bool? isChromeWeb = default, bool? isFirefox = default, bool? isSafari = default, bool? isWPWNS = default, bool? isAdm = default, bool? isChrome = default, string channelForExternalUserIds = default, string appId = default, string externalId = default, string idempotencyKey = default, StringMap contents = default, StringMap headings = default, StringMap subtitle = default, Object data = default, string huaweiMsgType = default, string url = default, string webUrl = default, string appUrl = default, Object iosAttachments = default, string templateId = default, bool? contentAvailable = default, bool mutableContent = default, string targetContentIdentifier = default, string bigPicture = default, string huaweiBigPicture = default, string admBigPicture = default, string chromeBigPicture = default, string chromeWebImage = default, List<Button> buttons = default, List<Button> webButtons = default, string iosCategory = default, string androidChannelId = default, string huaweiChannelId = default, string existingAndroidChannelId = default, string huaweiExistingChannelId = default, BasicNotificationAllOfAndroidBackgroundLayout androidBackgroundLayout = default, string smallIcon = default, string huaweiSmallIcon = default, string largeIcon = default, string huaweiLargeIcon = default, string admSmallIcon = default, string admLargeIcon = default, string chromeWebIcon = default, string chromeWebBadge = default, string firefoxIcon = default, string chromeIcon = default, string iosSound = default, string androidSound = default, string huaweiSound = default, string admSound = default, string wpWnsSound = default, string androidLedColor = default, string huaweiLedColor = default, string androidAccentColor = default, string huaweiAccentColor = default, int? androidVisibility = default, int? huaweiVisibility = default, string iosBadgeType = default, int? iosBadgeCount = default, string collapseId = default, string webPushTopic = default, Object apnsAlert = default, string delayedOption = default, string deliveryTimeOfDay = default, int? ttl = default, int? priority = default, string apnsPushTypeOverride = default, int? throttleRatePerMinute = default, string androidGroup = default, string androidGroupMessage = default, string admGroup = default, Object admGroupMessage = default, string threadId = default, string summaryArg = default, int summaryArgCount = default, string emailSubject = default, string emailBody = default, string emailFromName = default, string emailFromAddress = default, string emailPreheader = default, bool includeUnsubscribed = default, string smsFrom = default, List<string> smsMediaUrls = default, List<Filter> filters = default, Object customData = default, int successful = default, int failed = default, int errored = default, int converted = default, int? received = default, List<OutcomeData> outcomes = default, int remaining = default, long queuedAt = default, long? sendAfter = default, long? completedAt = default, PlatformDeliveryData platformDeliveryStats = default)
    {
    ...
    public override string ToString()
    {
        ...
        _ = sb.Append("class NotificationWithMeta {\n");
        ...
        _ = sb.Append("  IsIos: ").Append(IsIos).Append("\n");
        _ = sb.Append("  IsAndroid: ").Append(IsAndroid).Append("\n");
        _ = sb.Append("  IsHuawei: ").Append(IsHuawei).Append("\n");
        _ = sb.Append("  IsAnyWeb: ").Append(IsAnyWeb).Append("\n");
        _ = sb.Append("  IsChromeWeb: ").Append(IsChromeWeb).Append("\n");
        _ = sb.Append("  IsFirefox: ").Append(IsFirefox).Append("\n");
        _ = sb.Append("  IsSafari: ").Append(IsSafari).Append("\n");
        _ = sb.Append("  IsWPWNS: ").Append(IsWPWNS).Append("\n");
        _ = sb.Append("  IsAdm: ").Append(IsAdm).Append("\n");
        _ = sb.Append("  IsChrome: ").Append(IsChrome).Append("\n");
        _ = sb.Append("  ChannelForExternalUserIds: ").Append(ChannelForExternalUserIds).Append("\n");
        _ = sb.Append("  AppId: ").Append(AppId).Append("\n");
        _ = sb.Append("  ExternalId: ").Append(ExternalId).Append("\n");
        _ = sb.Append("  IdempotencyKey: ").Append(IdempotencyKey).Append("\n");
        _ = sb.Append("  Contents: ").Append(Contents).Append("\n");
        _ = sb.Append("  Headings: ").Append(Headings).Append("\n");
        _ = sb.Append("  Subtitle: ").Append(Subtitle).Append("\n");
        _ = sb.Append("  Data: ").Append(Data).Append("\n");
        _ = sb.Append("  HuaweiMsgType: ").Append(HuaweiMsgType).Append("\n");
        _ = sb.Append("  Url: ").Append(Url).Append("\n");
        _ = sb.Append("  WebUrl: ").Append(WebUrl).Append("\n");
        _ = sb.Append("  AppUrl: ").Append(AppUrl).Append("\n");
        _ = sb.Append("  IosAttachments: ").Append(IosAttachments).Append("\n");
        _ = sb.Append("  TemplateId: ").Append(TemplateId).Append("\n");
        _ = sb.Append("  ContentAvailable: ").Append(ContentAvailable).Append("\n");
        _ = sb.Append("  MutableContent: ").Append(MutableContent).Append("\n");
        _ = sb.Append("  TargetContentIdentifier: ").Append(TargetContentIdentifier).Append("\n");
        _ = sb.Append("  BigPicture: ").Append(BigPicture).Append("\n");
        _ = sb.Append("  HuaweiBigPicture: ").Append(HuaweiBigPicture).Append("\n");
        _ = sb.Append("  AdmBigPicture: ").Append(AdmBigPicture).Append("\n");
        _ = sb.Append("  ChromeBigPicture: ").Append(ChromeBigPicture).Append("\n");
        _ = sb.Append("  ChromeWebImage: ").Append(ChromeWebImage).Append("\n");
        _ = sb.Append("  Buttons: ").Append(Buttons).Append("\n");
        _ = sb.Append("  WebButtons: ").Append(WebButtons).Append("\n");
        _ = sb.Append("  IosCategory: ").Append(IosCategory).Append("\n");
        _ = sb.Append("  AndroidChannelId: ").Append(AndroidChannelId).Append("\n");
        _ = sb.Append("  HuaweiChannelId: ").Append(HuaweiChannelId).Append("\n");
        _ = sb.Append("  ExistingAndroidChannelId: ").Append(ExistingAndroidChannelId).Append("\n");
        _ = sb.Append("  HuaweiExistingChannelId: ").Append(HuaweiExistingChannelId).Append("\n");
        _ = sb.Append("  AndroidBackgroundLayout: ").Append(AndroidBackgroundLayout).Append("\n");
        _ = sb.Append("  SmallIcon: ").Append(SmallIcon).Append("\n");
        _ = sb.Append("  HuaweiSmallIcon: ").Append(HuaweiSmallIcon).Append("\n");
        _ = sb.Append("  LargeIcon: ").Append(LargeIcon).Append("\n");
        _ = sb.Append("  HuaweiLargeIcon: ").Append(HuaweiLargeIcon).Append("\n");
        _ = sb.Append("  AdmSmallIcon: ").Append(AdmSmallIcon).Append("\n");
        _ = sb.Append("  AdmLargeIcon: ").Append(AdmLargeIcon).Append("\n");
        _ = sb.Append("  ChromeWebIcon: ").Append(ChromeWebIcon).Append("\n");
        _ = sb.Append("  ChromeWebBadge: ").Append(ChromeWebBadge).Append("\n");
        _ = sb.Append("  FirefoxIcon: ").Append(FirefoxIcon).Append("\n");
        _ = sb.Append("  ChromeIcon: ").Append(ChromeIcon).Append("\n");
        _ = sb.Append("  IosSound: ").Append(IosSound).Append("\n");
        _ = sb.Append("  AndroidSound: ").Append(AndroidSound).Append("\n");
        _ = sb.Append("  HuaweiSound: ").Append(HuaweiSound).Append("\n");
        _ = sb.Append("  AdmSound: ").Append(AdmSound).Append("\n");
        _ = sb.Append("  WpWnsSound: ").Append(WpWnsSound).Append("\n");
        _ = sb.Append("  AndroidLedColor: ").Append(AndroidLedColor).Append("\n");
        _ = sb.Append("  HuaweiLedColor: ").Append(HuaweiLedColor).Append("\n");
        _ = sb.Append("  AndroidAccentColor: ").Append(AndroidAccentColor).Append("\n");
        _ = sb.Append("  HuaweiAccentColor: ").Append(HuaweiAccentColor).Append("\n");
        _ = sb.Append("  AndroidVisibility: ").Append(AndroidVisibility).Append("\n");
        _ = sb.Append("  HuaweiVisibility: ").Append(HuaweiVisibility).Append("\n");
        _ = sb.Append("  IosBadgeType: ").Append(IosBadgeType).Append("\n");
        _ = sb.Append("  IosBadgeCount: ").Append(IosBadgeCount).Append("\n");
        _ = sb.Append("  CollapseId: ").Append(CollapseId).Append("\n");
        _ = sb.Append("  WebPushTopic: ").Append(WebPushTopic).Append("\n");
        _ = sb.Append("  ApnsAlert: ").Append(ApnsAlert).Append("\n");
        _ = sb.Append("  DelayedOption: ").Append(DelayedOption).Append("\n");
        _ = sb.Append("  DeliveryTimeOfDay: ").Append(DeliveryTimeOfDay).Append("\n");
        _ = sb.Append("  Ttl: ").Append(Ttl).Append("\n");
        _ = sb.Append("  Priority: ").Append(Priority).Append("\n");
        _ = sb.Append("  ApnsPushTypeOverride: ").Append(ApnsPushTypeOverride).Append("\n");
        _ = sb.Append("  ThrottleRatePerMinute: ").Append(ThrottleRatePerMinute).Append("\n");
        _ = sb.Append("  AndroidGroup: ").Append(AndroidGroup).Append("\n");
        _ = sb.Append("  AndroidGroupMessage: ").Append(AndroidGroupMessage).Append("\n");
        _ = sb.Append("  AdmGroup: ").Append(AdmGroup).Append("\n");
        _ = sb.Append("  AdmGroupMessage: ").Append(AdmGroupMessage).Append("\n");
        _ = sb.Append("  ThreadId: ").Append(ThreadId).Append("\n");
        _ = sb.Append("  SummaryArg: ").Append(SummaryArg).Append("\n");
        _ = sb.Append("  SummaryArgCount: ").Append(SummaryArgCount).Append("\n");
        _ = sb.Append("  EmailSubject: ").Append(EmailSubject).Append("\n");
        _ = sb.Append("  EmailBody: ").Append(EmailBody).Append("\n");
        _ = sb.Append("  EmailFromName: ").Append(EmailFromName).Append("\n");
        _ = sb.Append("  EmailFromAddress: ").Append(EmailFromAddress).Append("\n");
        _ = sb.Append("  EmailPreheader: ").Append(EmailPreheader).Append("\n");
        _ = sb.Append("  IncludeUnsubscribed: ").Append(IncludeUnsubscribed).Append("\n");
        _ = sb.Append("  SmsFrom: ").Append(SmsFrom).Append("\n");
        _ = sb.Append("  SmsMediaUrls: ").Append(SmsMediaUrls).Append("\n");
        _ = sb.Append("  Filters: ").Append(Filters).Append("\n");
        _ = sb.Append("  CustomData: ").Append(CustomData).Append("\n");
    ...
    public override bool Equals(object input) => this.Equals(input as NotificationWithMeta);
    ...
    /// <returns>Boolean</returns>
    public bool Equals(NotificationWithMeta input) => input == null
            ? false
            : (
